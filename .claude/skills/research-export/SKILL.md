...
description: Generate a shareable markdown snapshot of the current research roadmap (topic, objectives, timeline progress, active/merged/dead branches, tags) from research_data/. Use when the user wants to export, share, summarize, or report the current state of their roadmap — e.g. for a teammate without Claude Code, a status update, or a thesis progress section.
---
